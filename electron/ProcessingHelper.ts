...
4. A clear explanation of the changes needed` 
        ...
        try {
          const debugPrompt = `你是一个编程面试助手，正在帮助调试和改进解决方案。请分析这些包含错误信息、不正确输出或测试用例的截图，并提供详细的调试帮助。

我正在用${language}解决这个编程问题: "${problemInfo.problem_statement}"。我需要帮助调试或改进我的解决方案。
...
如果包含代码示例，请使用正确的markdown代码块并指定语言
`;
